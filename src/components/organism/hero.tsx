      ...
      <Template>
        <div className="flex md:flex-row gap-5 mt-5 md:gap-12 flex-col-reverse mb-24 items-center">
          <div className=" w-full md:w-2/3 flex flex-col">
            <Box>
              Discover Your Favorite Pokémon! whether you're a seasoned Trainer
              or just starting your journey, our tool helps you find the Pokémon
              that best matches your style and personality. Let us guide you to
